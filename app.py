...
def register():
    if request.method == "POST":
        ...
        try:
            ...
            # 3. Insert default budget + savings
            cursor.execute("""
...
def dashboard():
    ...
    try:
        ...
        # Budget and savings goal from database
        cursor.execute("""
...
def monthly_report():
    ...
    try:
        if request.method == "POST":
            ...
            # Convert YYYY-MM into year and month
